...
@NgModule({
  declarations: [AppComponent, LandingPagesComponent, BrowseAllPagesComponent, DetailEventPagesComponent, LoginPagesComponent, CreateEventPagesComponent, HeaderComponent, FooterComponent, CardEventComponent, ModalRegisterEventComponent, ManageEventPagesComponent, OrganizerProfilePagesComponent, UserProfilePagesComponent],
